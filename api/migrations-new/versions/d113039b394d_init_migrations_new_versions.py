"""init migrations-new versions

Revision ID: d113039b394d
Revises:
Create Date: 2025-03-18 14:20:56.560417
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("install_permission", sa.String(length=16), nullable=False),
        sa.Column("debug_permission", sa.String(length=16), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("provider", sa.String(length=255), nullable=False),
        sa.Column("source_info", models.types.JSONType(), nullable=False),
        sa.Column("created_at", sa.DateTime(), server_default=sa.text("CURRENT_TIMESTAMP"), nullable=False),
        sa.Column("updated_at", sa.DateTime(), server_default=sa.text("CURRENT_TIMESTAMP"), nullable=False),
        sa.Column("disabled", sa.Boolean(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("retrieval_model", models.types.JSONType(), nullable=True),
