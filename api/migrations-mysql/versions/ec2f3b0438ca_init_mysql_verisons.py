...
Revision ID: ec2f3b0438ca
Revises:
Create Date: 2025-03-20 01:56:50.959754
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("is_universal", sa.Boolean(), server_default=sa.text("false"), nullable=False),
    ...
    with op.batch_alter_table("child_chunks", schema=None) as batch_op:
        batch_op.create_index(
            ...
            ["tenant_id", "dataset_id", "document_id", "segment_id", "index_node_id"],
            unique=False,
        )
    ...
    op.create_table(
        ...
        sa.Column("built_in_field_enabled", sa.Boolean(), server_default=sa.text("false"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(), server_default=sa.text("CURRENT_TIMESTAMP"), nullable=False),
        sa.Column("finished_at", sa.DateTime(), nullable=True),
        sa.Column("exceptions_count", sa.Integer(), server_default=sa.text("0"), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("marked_comment", sa.String(length=255), server_default="", nullable=False),
